...
class SolveNQ:
    ...
    def byDFS(self, board):
        # Use recursive and for loop with a stack to implement Depth First Search
        # With each row check all position of the next row. With first satified position continue check all next row's position
